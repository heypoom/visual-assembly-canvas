...
pub struct Machine {
    ...
    /// Stores the event handlers for the machine.
    pub handlers: Handlers,

    /// Stores the events generated by the machine.
    /// This often contains the side effects produced by this machine.
    pub events: Vec<Event>,

    /// Stores the messages sent to this machine.
    pub mailboxes: Vec<Message>,
}
